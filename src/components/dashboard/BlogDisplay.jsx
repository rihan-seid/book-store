...
const BlogDisplay = () => {
  ...
  const blogsPerPage = 10;
    ...
    // const API_BASE_URL = import.meta.env.VITE_API_URL || 'https://victor-test-be.onrender.com';
      ...
      <div className="flex-1 p-4 md:p-8 mt-10 ">
        ...
        {blogs.length === 0 ? (
          <div className="text-center py-12 bg-white rounded-lg shadow">
            <p className="text-gray-500 text-lg mb-4">No blogs found. Create your first blog!</p>
            <button
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="flex space-x-1">
                          {blog.images?.slice(0, 3).map((image, index) => (
                            <div key={index} className="h-10 w-10 rounded-md overflow-hidden border border-gray-200">
                              <img
                                src={image}
                                alt={`Preview ${index}`}
